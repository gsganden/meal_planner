...
This module provides RESTful API endpoints for creating, reading, updating,
and deleting recipes. All endpoints follow REST conventions and return
appropriate HTTP status codes. Database operations are wrapped with proper
